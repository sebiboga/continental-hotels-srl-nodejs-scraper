...
**job_seeker_ro_spider** — scraper pentru job-urile Continental Hotels din România.

Extrage anunțurile de pe [Continental Hotels Careers Romania](https://www.jobs-continentalhotels.ro/en/jobs/romania) și le publică în [peviitor.ro](https://peviitor.ro) prin API-ul SOLR.
...
1. **Validează compania** — interoghează API-ul public ANAF ([demoanaf.ro](https://demoanaf.ro)) după CIF-ul Continental Hotels (1559737) și verifică:
   - Denumirea oficială: CONTINENTAL HOTELS SA
   - Status: activ/inactiv/radiat
   - Adresa completă din registrul comerțului
2. **Cross-validează cu Peviitor** — verifică existența companiei în API-ul Peviitor
3. **Scrape-uiește job-urile** — extrage lista completă de job-uri din API-ul public Continental Hotels Careers, filtrat pe România
...
6. **Generează docs/jobs.md** — fișier markdown cu informații companie + toate job-urile curente, publicat pe [GitHub Pages](https://sebiboga.github.io/continental-hotels-srl-nodejs-scraper/jobs.md)
...
|---|---|---|
| Continental Hotels Careers | `https://www.jobs-continentalhotels.ro/api/jobs/v2/search/...` | Public |
...
Continental Hotels Careers [robots.txt](https://www.jobs-continentalhotels.ro/robots.txt) dezactivează:
...
# Doar E2E (API real Continental Hotels + ANAF + SOLR)
npm run test:e2e
```
