...
| group        | string   | Parent company group (e.g. "Continental Hotels") |
...
- **scraperFile**: Full URL to GitHub raw workflow YML (e.g. `https://raw.githubusercontent.com/sebiboga/continental-hotels-srl-nodejs-scraper/main/.github/workflows/job-seeker-ro-spider.yml`)