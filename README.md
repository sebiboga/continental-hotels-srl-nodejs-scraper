# job_seeker_ro_spider — Continental Hotels Careers Romania Scraper

[![Oportunitati SI Cariere](https://github.com/sebiboga/continental-hotels-srl-nodejs-scraper/actions/workflows/job-seeker-ro-spider.yml/badge.svg)](https://github.com/sebiboga/continental-hotels-srl-nodejs-scraper/actions/workflows/job-seeker-ro-spider.yml)
[![Automation Tests](https://github.com/sebiboga/continental-hotels-srl-nodejs-scraper/actions/workflows/automation-testing.yml/badge.svg)](https://github.com/sebiboga/continental-hotels-srl-nodejs-scraper/actions/workflows/automation-testing.yml)

[![Version](https://img.shields.io/github/package-json/v/sebiboga/continental-hotels-srl-nodejs-scraper?label=version&color=blue)](CHANGELOG.md)
[![Test Results](https://img.shields.io/badge/test--results-HTML-9b59b6)](https://sebiboga.github.io/continental-hotels-srl-nodejs-scraper/test-results/)
...
[![GitHub Pages](https://img.shields.io/github/deployments/sebiboga/continental-hotels-srl-nodejs-scraper/github-pages?label=GitHub%20Pages)](https://sebiboga.github.io/continental-hotels-srl-nodejs-scraper/)

**job_seeker_ro_spider** — un scraper pentru job-urile CONTINENTAL HOTELS SA din România. Extrage anunțurile de pe [jobs-continentalhotels.ro](https://www.jobs-continentalhotels.ro) (POST AJAX → HTML fragment, parsat cu cheerio) și le publică în [peviitor.ro](https://peviitor.ro) prin API-ul SOLR.
...
Proiectul automatizează colectarea zilnică a job-urilor Continental Hotels din România, menținând board-ul peviitor.ro la zi cu cele mai recente oportunități de carieră.

## Features

- Extrage job-uri printr-un POST AJAX la `/_ajax/get-job-list.php` (returnează HTML fragment, parsat cu cheerio)
...
│   ├── validate-continental-jobs.js   # SOLR job URL validation script
│   ├── unit/
...
│   ├── e2e/
│   │   └── scraper.test.js     # Full pipeline tests with real Continental Hotels API
│   └── consistency/
...
3. Scrapes current job listings from Continental Hotels Careers
...
7. Generates [`docs/jobs.md`](https://sebiboga.github.io/continental-hotels-srl-nodejs-scraper/jobs.md) with company info and all scraped jobs
8. Pushes test reports and `docs/jobs.md` to [`docs/`](https://sebiboga.github.io/continental-hotels-srl-nodejs-scraper/)

### Test Automation

The `automation-testing.yml` workflow runs on every push and pull request. It:
1. Ensures Continental Hotels exists in the company core
2. Runs unit, integration, e2e, and consistency tests
3. Validates data integrity in Solr
4. Pushes test reports to [`docs/test-results/`](https://sebiboga.github.io/continental-hotels-srl-nodejs-scraper/test-results/)
...
Acest scraper respectă regulile din [robots.txt](https://www.jobs-continentalhotels.ro/robots.txt) al Continental Hotels Careers. Pentru analiza completă, vezi [ROBOTS.md](ROBOTS.md).
...
This scraper is designed for educational purposes and legitimate job data aggregation for the Romanian job market. Please respect Continental Hotels's Terms of Service and robots.txt when using this scraper.
