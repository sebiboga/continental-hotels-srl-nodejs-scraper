...
### 2. Issues & GitHub
- **Orice modificare de cod trebuie să aibă un issue în GitHub Issues** (vezi ISSUES.md)
...
- `SOLR_AUTH` must be set in `.env.local` for SOLR tests (ask a maintainer for the value)
